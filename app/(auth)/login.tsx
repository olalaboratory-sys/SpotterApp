...
export default function LoginScreen() {
  ...
  const { signInWithEmail, handleGoogleCredential, handleAppleCredential } = useAuth();
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity style={styles.primaryBtn} onPress={handleEmailLogin} activeOpacity={0.85}>
            ...
            <View style={styles.socialRow}>
              ...
              <TouchableOpacity style={[styles.socialBtn, styles.appleBtn]} onPress={handleAppleLogin} activeOpacity={0.8}>
